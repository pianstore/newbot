...
const menu = {
    ...
    maker: [
        'attp','attp2','brat','brat2','bratcustom','qc','qc2','qcstick','smeme','sticker','ttp','wm',
    ],
    more: [
        'apikey','cekapikey','grubbot','sc','style','tutor','ratelimit','report',
    ],
    owner: [
        'addlevel','addlimit','addmoney','addowner','addplugin','addpremium','addrespon','block','backup','buatstory','creategc','delowner','delplugin','delprem','deletejadibot','delresponse','delsewa','demoteme','gctag','grubbot','infosystem','ipserver','jadibot','join','jpm','listblock','listprem','listrespon','listsewa','listjadibot','outallgc','outgc','promoteme','public','reset','restart','self','setbio','setname','setppbot','stopjadibot','sewabot','sewabotid',,'tambahsewa','totalsewa','unblock','update',
    ],
    panel: [
...
async function handle(sock, messageInfo) {
    ...
    const roleUser  = isOwner(sender) ? 'Owner' : await isPremiumUser(sender) ? 'Premium' : 'user';
