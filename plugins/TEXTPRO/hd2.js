const { ReminiV2 } = require('@scrape/remini');
...
async function handle(sock, messageInfo) {
    ...
    try {
        ...
        // Proses menggunakan ReminiV2
        const result = await ReminiV2(mediaBuffer);
...
module.exports = {
    handle,
    Commands    : ['hd2', 'remini2'], // Perintah yang diproses oleh handler ini
    OnlyPremium : false,
    OnlyOwner   : false,
